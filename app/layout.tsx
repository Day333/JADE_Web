...
// The public production domain, so og:image and other absolute URLs work for
// everyone. VERCEL_URL is the per-deployment domain, which has deployment
// protection and is not reachable by social-media crawlers.
