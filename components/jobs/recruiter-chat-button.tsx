...
const NO_RECRUITER_NOTE = `This company's recruiter is not on ${APP_NAME} yet`;

/** "Chat with Recruiter" — disabled with an explanation for listings without a recruiter on the platform. */
export function RecruiterChatButton({
  ...
  return (
    <span tabIndex={0} aria-label={NO_RECRUITER_NOTE} className={cn("group relative inline-flex rounded-md focus:outline-none focus-visible:ring-1 focus-visible:ring-ring", className)}>
